            ...
            .then((snapshot) => {
              snapshot.forEach((doc) => {
                ...
                db.collection("all_notifications").add({
                  ...
                  message:
                    name + " " + lastName + " received the medicine " + bookName,
    ...
    if (this.state.IsBookRequestActive === true) {
      return (
        <View style={{ flex: 1}}>
          ...
          >
            <MyHeader title="Medicine Status" navigation={this.props.navigation} />
          </View>
          <View
        ...
        <View style={{ flex: 0.9 }}>
          ...
          {this.state.showFlatlist ? (
            ...
            <View style={{ alignItems: "center" }}>
              ...
              label={"Prescription"}
              placeholder={"Provide scanned image of prescription"}
              />
              <TouchableOpacity> 
